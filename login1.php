...
require "languages/login_".$_SESSION['lang'].".php";	
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 text-xs-center">
					...
					<small class="mbr-section-subtitle">Log your company in</small>
				</div>
			</div>
		</div>
	</div>
                ...
                <div class="col-xs-12 col-lg-10 col-lg-offset-1">
                    ...
                    <form id="formRegister" action="" method="post" data-form-title="Register">
                        ...
                        <div class="row row-sm-offset">
                            ...
                            <div class="col-xs-12 col-md-6 col-md-offset-3">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-g-phone">Password<span class="form-asterisk">*</span></label>
							...
							<div class="col-xs-12 col-md-6 col-md-offset-3"><button type="submit" name="login" class="btn btn-primary">LOGIN</button></div>
                        </div>
                    </form>
                </div>
            </div>
